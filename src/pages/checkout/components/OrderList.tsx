                    ...
                    <div key={index} className="flex py-3 space-x-3">
                        ...
                        <div className="grow">
                            <div className="flex flex-row justify-between">
                                ...
                                <p className="font-semibold text-sm mb-1">{`Rp ${currency(
                                    cartItem.price * cartItem.qty
                                )}`}</p>
                            </div>
                            <p className="font-normal text-sm text-gray-400 mb-1">{`${currency(cartItem.price)}`}</p>
                            <p className="font-normal text-gray-400 text-sm mb-1">{cartItem.qty} item(s)</p>
                        </div>
                    </div>
                )}
            />
