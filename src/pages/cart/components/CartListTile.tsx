      ...
      <div className="grow flex space-x-4">
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="flex items-center space-x-4 ">
            ...
            <p className="font-bold text-sm w-6 text-center">
              {props.product.qty}
            </p>
            <ButtonIconOutline
              disabled={props.product.qty < 99 ? false : true}
              onClick={() => incrementCartItemQty()}
            >
              <IoAddOutline
                size={16}
                className={classNames({
                  "text-green-600": props.product.qty < 99,
                  "text-gray-300": props.product.qty > 98,
                })}
              />
            </ButtonIconOutline>
          </div>
